...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		//emp3.whoAmI(); // prints PART TIME EMPLOYEE because emp3 was originally a part time employee
		//emp3.getHourlyRate(); // returns syntax error because Employee does not have a method called "getHourlyRate()"
		...
		// because You can't cast an Employee to PartTimeEmployee because it is not a subclass of it.
